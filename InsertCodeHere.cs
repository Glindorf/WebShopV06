...
namespace WebShopV06
{
    public class InsertCodeHere
    {
        public void MyCode()
        {
            ...
            receiveSpecialOffer3 = (noOfBooksInOrder >= 10) || (noOfDVDsInOrder >= 10) || (noOfGamesInOrder >= 10);

            // SO#4
            bool receiveSpecialOffer4 = false;
            receiveSpecialOffer4 = ((noOfDVDsInOrder >= 10) && (noOfDVDsInOrder <= 20)) || (noOfGamesInOrder > 5);
            ...
            bool receiveSpecialOffer = case1 || case2 || case3 || case4 || case5 || case6;
            System.Console.WriteLine($"You qualify for the ekstra special offer: {receiveSpecialOffer}");
